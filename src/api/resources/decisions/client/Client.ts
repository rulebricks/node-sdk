...
export class Decisions {
     ...
     *
     * @param {Rulebricks.DecisionsQueryRequest} request
     ...
     */
    public async query(
        request: Rulebricks.DecisionsQueryRequest,
        requestOptions?: Decisions.RequestOptions,
    ): Promise<Rulebricks.DecisionLogResponse> {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RulebricksTimeoutError("Timeout exceeded when calling GET /decisions/query.");
            case "unknown":
                throw new errors.RulebricksError({
