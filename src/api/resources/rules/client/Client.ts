...
export class Rules {
    ...
    public async solve(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `api/v1/solve/${encodeURIComponent(slug)}`,
            ),
            method: "POST",
            headers: {
     ...
     *         }])
     */
    public async bulkSolve(
        slug: string,
        request: RulebricksApi.DynamicRequestPayload[],
        requestOptions?: Rules.RequestOptions,
    ): Promise<RulebricksApi.BulkRuleResponseItem[]> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
                `api/v1/bulk-solve/${encodeURIComponent(slug)}`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RulebricksApiTimeoutError(
                    "Timeout exceeded when calling POST /api/v1/bulk-solve/{slug}.",
                );
            case "unknown":
                throw new errors.RulebricksApiError({
                    message: _response.error.errorMessage,
     ...
     *     })
     */
    public async parallelSolve(
        request: RulebricksApi.ParallelSolveRequest,
        requestOptions?: Rules.RequestOptions,
    ): Promise<RulebricksApi.ParallelSolveResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.RulebricksApiTimeoutError(
                    "Timeout exceeded when calling POST /api/v1/parallel-solve.",
                );
            case "unknown":
                throw new errors.RulebricksApiError({
                    message: _response.error.errorMessage,
