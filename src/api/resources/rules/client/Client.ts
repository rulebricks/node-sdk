...
export class Rules {
    ...
    public async solve(
        slug: string,
        request: Rulebricks.DynamicRequestPayload,
        requestOptions?: Rules.RequestOptions,
    ): Promise<Rulebricks.DynamicResponsePayload> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.RulebricksEnvironment.Default,
                `solve/${encodeURIComponent(slug)}`,
            ),
            method: "POST",
            headers: {
    ...
    public async bulkSolve(
        ...
        request: Rulebricks.DynamicRequestPayload[],
        requestOptions?: Rules.RequestOptions,
    ): Promise<Rulebricks.BulkRuleResponseItem[]> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.RulebricksEnvironment.Default,
                `bulk-solve/${encodeURIComponent(slug)}`,
            ),
            method: "POST",
            headers: {
                "X-Fern-Language": "JavaScript",
    ...
    public async parallelSolve(
        ...
        requestOptions?: Rules.RequestOptions,
    ): Promise<Rulebricks.ParallelSolveResponse> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
